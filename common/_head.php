        ...
        <div class="headerBox">
            ...
            <div class="headerBox__item headerBox__search">
                <form class="searchH">
                    <div class="searchH__box">
                        <input class="searchH__input" type="search" placeholder="Search" />
            ...
            <div class="headerBox__item headerBox__account">
                ...
                <div class="headerBox__box headerBox__bag">
                    <div class="bagH">
                        <span class="bagH__number">3</span>
        ...
        <tr>
            <td background="<?= $SITE_ROOT ?>/img/logo_pas.gif">
                <table cellpadding=0 cellspacing=0 border=0 width=100% height=65>
                    <tr valign=top>
                        <td rowspan=2><a href="<?= $SITE_ROOT ?>/"><img src="<?= $SITE_ROOT ?>/img/logo.jpg" width=200
                                                                        height=60 border=0
                                                                        alt="<?= to_html($Config['site_name']) ?> - Home &#10;&#13;(<?= to_html($Config['meta_title']) ?>)"></a>
                        </td>
                        <td align=right>
                            <?
                            //------------------------------------------------------------------------------\
                            if ($CUSTOMER_ID) {
                                ?>
                                <a href="<?= $SITE_ROOT ?>/logout.html?toploginform_url=<?= to_url($REQUEST_URI) ?>"
                                   rel='nofollow' class="toplogin"><u><b>Logout</b></u></a> &nbsp;
                            <?
                            }
                            elseif (!$NO_EXTERNAL) {
                            ?>
                                    ...
                                    <form name=toploginform action='<?= $SITE_ROOT ?>/login.html' method=post
                                        ...
                                        <tr>
                                            <td class=toplogin>L:<input type=text name="email" maxlength=20 size=10
                                                                        ...
                                                                        class=toplogin></td>
                                            <td class=toplogin>P:<input type="password" name="password" maxlength=20
                                                                        size=10
                                                                        value="<?= to_html($_POST['password']) ?>"
                                                                        class=toplogin></td>
                                            <td><input type="submit" value='Login' class=toplogin
                                                       style='border:1 #CCCCCC solid;background-color:#7495E8;color:#FFFFFF;font-weight:bold;'>
                                            </td>
                                            <td>
                                                <a href="javascript: void(0)" class="toplogin" rel="nofollow"
                                                   onClick="topForgotPassword(); return false">Forgot Password?</a><br>
                                                <a href="<?= $SITE_ROOT ?>/register_form.html" class="toplogin"
...
//------------------------------------------------------------------------------/
                    ...
                    <tr>
                        <td valign=bottom align=right style='color:#FFFFFF;padding:3 10 3 0' nowrap>
                            <a href="<?= $SITE_ROOT ?>/"><img border=0 src="<?= $SITE_ROOT ?>/img/01-_01.gif" width=20
                                                              height=14 alt='Home'></a><a
                                href='mailto:<?= $Config['contact_email'] ?>'><img border=0
                                                                                   src="<?= $SITE_ROOT ?>/img/01-_02.gif"
                                                                                   width=26 height=14 alt='Mail Us'></a><a
                                href="<?= $SITE_ROOT ?>/map.html"><img border=0 src="<?= $SITE_ROOT ?>/img/01-_03.gif"
                                                                       width=19 height=14 alt='Site Map'></a>
                        </td>
                    </tr>
                </table>
            </td>
...
//------------------------------------------------\
                                ...
                                <? } else { ?>
                                    <a class=menu href="<?= $SECURE_URL_HEADER ?>/login_form.html"
...
//------------------------------------------------/
                        ...
                        <td align=right nowrap width=100%>
                            ...
                            <form action="<?= $SITE_ROOT ?>/search_prod.html"
                                ...
                                <input type=text name='search_text' size=10 style='height:18;font-size:12' maxlength=100
                                       value="<?= to_html($search_text) ?>">
                                <input type=image src="<?= $SITE_ROOT ?>/img/buttons/search.gif" width=16 height=16
                                       border=0 style='border:0;background-color:#7F939D;' align=absmiddle
                                       alt="Search product"> &nbsp;
                            </form>
